...
namespace WebServicesFigaro.Controllers
{
    public class TipoCocinaMvcController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Titulo,Imagen,Icono")] TipoCocina tipoCocina)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Titulo,Imagen,Icono")] TipoCocina tipoCocina)
        {
            if (ModelState.IsValid)
            {
